...
class Hinvkardex(Base):
    __tablename__ = "hinvkardex"
    ...
    invkardex = Column(Integer,primary_key=True, nullable=False)

    def __repr__(self):
        return "<Hinvkardex(mes={self.mes})>"