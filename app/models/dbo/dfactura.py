...
class DFactura(Base):
    ...
    dfactura = Column(Integer, primary_key=True, nullable=False, autoincrement=True)
    ...
    cotiza = Column(Integer, nullable=False)

    # Relaciones
    # factura_rel = relationship("Factura", back_populates="dfactura_set")  # Comentado automáticamente
    # kardex_rel = relationship("Kardex", back_populates="dfactura_set")  # Comentado automáticamente

    def __repr__(self):
        return "<Dfactura(dfactura={self.dfactura})>"