...
class Anticipos(Base):
    ...
    anticipos = Column(Integer, primary_key=True, nullable=False, autoincrement=True)
    ...
    habono = Column(Numeric(18, 6), nullable=False)
    hafecta = Column(Numeric(18, 6), nullable=False)
    hexenta = Column(Numeric(18, 6), nullable=False)
    hviva = Column(Numeric(18, 6), nullable=False)
    pagos = Column(Integer, nullable=False)

    def __repr__(self):
        return "<Anticipos(anticipos={self.anticipos})>"